...
def Exists(file):
  files = ["defaultClicCrossingAngle.mac","clic_ild_cdr500.steer",
           ...
           "clic_cdr_postPandora.lcsim","clic_cdr_prePandoraOverlay.lcsim","clic_cdr_prePandoraOverlay_1400.0.lcsim",
           "clic_cdr_prePandoraOverlay_3000.0.lcsim",
           "clic_cdr_postPandoraOverlay.lcsim","clic_ild_cdr.gear",
           "clic_ild_cdr500.gear","clic_ild_cdr_steering_overlay.xml","clic_ild_cdr_steering_overlay_3000.0.xml",
           "clic_ild_cdr_steering_overlay_1400.0.xml",
           "clic_ild_cdr500_steering_overlay.xml","clic_ild_cdr500_steering_overlay_350.0.xml","clic_ild_cdr_steering.xml",
