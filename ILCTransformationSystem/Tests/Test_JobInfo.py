...
class TestJI( unittest.TestCase ):
  ...
  def setUp( self ):
    ...
    self.jdl2 = { 'LogTargetPath': "/ilc/prod/clic/500gev/yyveyx_o/ILD/REC/00006326/LOG/00006326_015.tar",
                  ...
                  'JobRequirements': { 'OwnerDN': "/DC=ch/DC=cern/OU=Organic Units/OU=Users/CN=sailer/CN=683529/CN=Andre Sailer",
                                       'VirtualOrganization': "ilc",
                                       'Setup': "ILC-Production",
                                       'CPUTime': 300000,
                                       'OwnerGroup': "ilc_prod",
                                       'Platforms': [ "x86_64-slc6-gcc44-opt",
                  ...
                  'SoftwarePackages': [ "overlayinput.1",
                                        "marlin.v0111Prod",
                                      ],
                  'DebugLFNs': "",
                  'Status': "Created",
                  ...
                  'Origin': "DIRAC",
                  'VirtualOrganization': "ilc",
                  'ProductionOutputData': [ "/ilc/prod/clic/500gev/yyveyx_o/ILD/REC/00006326/000/yyveyx_o_rec_6326_15.slcio",
    ...
    self.jdlBrokenContent= { 'LogTargetPath': "/ilc/prod/clic/500gev/yyveyx_o/ILD/REC/00006326/LOG/00006326_015.tar",
                             'Executable': "$DIRACROOT/scripts/dirac-jobexec",
                             'TaskID': 'muahahaha',
                             'SoftwareDistModule': "ILCDIRAC.Core.Utilities.CombinedSoftwareInstallation",
                             'JobName': "00006326_00000015",
    ...
    self.jdl1 = { 'LogTargetPath': "/ilc/prod/clic/3tev/e1e1_o/SID/SIM/00006301/LOG/00006301_10256.tar",
                  'Executable': "$DIRACROOT/scripts/dirac-jobexec",
                  'TaskID': 10256,
                  'SoftwareDistModule': "ILCDIRAC.Core.Utilities.CombinedSoftwareInstallation",
    ...
    self.jdlNoInput = { 'LogTargetPath': "/ilc/prod/clic/1.4tev/ea_qqqqnu/gen/00006498/LOG/00006498_1307.tar",
                        'Executable': "$DIRACROOT/scripts/dirac-jobexec",
                        'TaskID': 1307,
                        'SoftwareDistModule': "ILCDIRAC.Core.Utilities.CombinedSoftwareInstallation",
  ...
  def test_getOutputFiles( self ):
    ...
    ## two LFNs
    self.diracILC.getJobJDL.return_value = S_OK( self.jdl2 )
    jdlList = self.jbi._JobInfo__getJDL( self.diracILC )
    self.jbi._JobInfo__getOutputFiles( jdlList )
