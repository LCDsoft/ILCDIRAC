...
::::::
 ...
 Workflow
  - fix the copy path, missed the os.path.join
...
::::::
 ...
 Core
  - Merge the resolveIFPaths and resolveOFnames
  - Merge scripts, use gLogger
 Interfaces
  - Merge scripts, use gLogger
 Workflow
  - Result of the merge of the resolveIFPaths and resolveOFnames
...
::::::
 ...
 Core
  - Reshuffle the TARsoft utility a bit more
...
::::::
 ...
 Core
  - Don't check the md5sum of md5 summary file as it's never going to match
...
::::::
 ...
 OverlaySystem
  - Proper init of Client
 Workflow
  - Add more error printing in the std.out for easier debugging
  - use super() for class inheritance
...
::::::
 ...
 OverlaySystem
  - Missing proper Client instanciation
...
:::
 ...
 Doc
  - Doc folder containing epydoc config

CHANGE
::::::

 Core
  - Many things related to documentation
 Interfaces
  - Many things related to documentation
 Workflow
  - Many things related to documentation
