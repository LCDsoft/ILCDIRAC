...
from ILCDIRAC.DataManagementSystem.Agent.RequestOperations import CheckMigration

MODULE = 'ILCDIRAC.DataManagementSystem.Agent.RequestOperations.CheckMigration'
FILE_NAME = 'fileName'
N_FILES = 3
