...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/ILCDIRAC.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/ILCDIRAC.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/ILCDIRAC"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/ILCDIRAC"
	@echo "# devhelp"
...
releasenotes:
	python CompileReleaseNotes.py `git -C ${DIRAC}/ILCDIRAC describe --tags --abbrev=0`
...
completeDocumentation: releasenotes
	...
	rsync --delete -art Files source/DOC
	make clean
	make html
	@echo
