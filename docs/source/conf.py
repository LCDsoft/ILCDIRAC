# -*- coding: utf-8 -*-
#
# ILCDIRAC documentation build configuration file, created by
# sphinx-quickstart on Mon Oct 12 18:49:38 2015.
#
...
##
gitTag = subprocess.check_output( ["git", "-C", os.path.join( os.environ["DIRAC"], "ILCDIRAC"),
                                   "describe", "--tags", "--abbrev=0" ] )
gitTag = os.environ.get( "CI_COMMIT_TAG", gitTag ).strip()
release = gitTag
...
exclude_patterns = ['*.cfg','_build','_templates']
...
modindex_common_prefix = ['ILCDIRAC.']
...
latex_documents = [
  (master_doc, 'ILCDIRAC.tex', u'ILCDIRAC Documentation',
   u'S.Sposs,R.Ete,C.Grefe,P.Majewski,A.Sailer,M.Petric', 'manual'),
]
...
man_pages = [
    (master_doc, 'ilcdirac', u'ILCDIRAC Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ILCDIRAC', u'ILCDIRAC Documentation',
   author, 'ILCDIRAC', 'DIRAC Extension for the ILC VO',
   'Miscellaneous'),
]
...
# APS: automatically generate summaries
