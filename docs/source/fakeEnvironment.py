...
#pylint: disable=wrong-import-position, invalid-name, attribute-defined-outside-init, missing-docstring
...
sys.modules[ 'DIRAC.FrameWorkSystem.private.monitoring.PlotCache' ] = mock.Mock()
sys.modules[ 'DIRAC.FrameworkSystem.Client.MonitoringClient' ] = mock.Mock()
sys.modules[ 'DIRAC.FrameworkSystem.Client.MonitoringClient.gMonitor' ] = mock.Mock()


sys.modules[ 'DIRAC.WorkloadManagementSystem.Client.JobState.CachedJobState' ] = mock.Mock()
#sys.modules[ 'DIRAC.WorkloadManagementSystem.Client.JobState.CachedJobState.CachedJobState' ] = mock.Mock()
